const rusTranslations = {
  translation: {
    ...
    'Copy link to share app': 'Скопировать ссылку для установки приложения',
    ...
    'Instruction to add app to Home screen':
      'Как установить PWA?\n' +
      'Хотя это не обязательно, вы можете сохранить PWA на своем домашнем экране, чтобы сделать его более доступным.\n' +
      'Android\n\n' +
      'Откройте PWA-сайт в браузере (например, Chrome).\n' +
      'Нажмите кнопку меню (три точки) в адресной строке.\n' +
      'Выберите "Добавить на главный экран".\n' +
      'Отредактируйте название если нужно и нажмите "Добавить".\n\n' +
      'iOS\n' +
      'Откройте PWA-сайт в Safari.\n' +
      'Нажмите кнопку "Поделиться" (иконка со стрелкой внизу).\n' +
      'Прокрутите вниз и выберите "Добавить на экран Домой".\n' +
      'Введите имя и нажмите "Добавить".\n' +
      'Теперь PWA доступно на вашем домашнем экране, как обычное приложение.\n\n',
